-- start query 6 in stream 0 using template query27a.tpl using seed 1793886985
with results as
 (select i_item_id,
...
-- end query 6 in stream 0 using template query27a.tpl

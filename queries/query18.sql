-- start query 4 in stream 0 using template query18a.tpl using seed 576722453
with results as
 (select i_item_id,
        ca_country,
        ca_state, 
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (1,5,10,8,12,7) and
       d_year = 2001 and
       ca_state in ('MI','SC','OR','NC','TX','VA','NV')
 )
...
-- end query 4 in stream 0 using template query18a.tpl

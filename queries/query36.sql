-- start query 8 in stream 0 using template query36a.tpl using seed 809586027
with results as
 (select 
...
-- end query 8 in stream 0 using template query36a.tpl

-- start query 2 in stream 0 using template query10a.tpl using seed 1451914304
select  
  cd_gender,
  cd_marital_status,
  cd_education_status,
 ...
 where
  ...
  ca_county in ('New Castle County','Douglas County','Warrick County','La Porte County','Charlotte County') and
...
-- end query 2 in stream 0 using template query10a.tpl

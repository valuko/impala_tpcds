...
DROP VIEW IF exists q8_tmp1;
DROP VIEW IF exists q8_tmp2;
DROP VIEW IF exists q8_tmp3;
DROP VIEW IF exists q8_tmp4;

create view q8_tmp2 as
...
create view q8_tmp4 as 
select q8_tmp2.ca_zip from q8_tmp2 JOIN q8_tmp3 ON q8_tmp2.ca_zip = q8_tmp3.ca_zip
group by q8_tmp2.ca_zip;

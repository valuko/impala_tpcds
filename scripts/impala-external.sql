...
-- * location path (currently /user/root/tpcds/scale300)

create schema tpcds_300_text;
use tpcds_300_text;
...
stored as textfile
location '/user/root/tpcds/scale300/call_center'
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/root/tpcds/scale300/catalog_page'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/root/tpcds/scale300/catalog_returns'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/root/tpcds/scale300/catalog_sales'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/root/tpcds/scale300/customer'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/root/tpcds/scale300/customer_address'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/root/tpcds/scale300/customer_demographics'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/root/tpcds/scale300/date_dim'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/root/tpcds/scale300/household_demographics'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/root/tpcds/scale300/income_band'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/root/tpcds/scale300/inventory'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/root/tpcds/scale300/item'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/root/tpcds/scale300/promotion'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/root/tpcds/scale300/web_sales'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/root/tpcds/scale300/reason'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/root/tpcds/scale300/store'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/root/tpcds/scale300/store_returns'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/root/tpcds/scale300/store_sales'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/root/tpcds/scale300/time_dim'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/root/tpcds/scale300/warehouse'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/root/tpcds/scale300/web_page'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/root/tpcds/scale300/web_returns'
tblproperties ('serialization.null.format'='')
;
...
row format delimited fields terminated by '|'
stored as textfile
location '/user/root/tpcds/scale300/web_site'
tblproperties ('serialization.null.format'='')
;

--
-- adjust the source/text schema (tpcds_300_text)
-- and target/parquet schema (tpcds_300_parquet)
-- if necessary
--

use tpcds_300_parquet;

insert overwrite table call_center            select * from tpcds_300_text.call_center;
insert overwrite table catalog_page           select * from tpcds_300_text.catalog_page;
insert overwrite table customer               select * from tpcds_300_text.customer;
insert overwrite table customer_address       select * from tpcds_300_text.customer_address;
insert overwrite table customer_demographics  select * from tpcds_300_text.customer_demographics;
insert overwrite table date_dim               select * from tpcds_300_text.date_dim;
insert overwrite table household_demographics select * from tpcds_300_text.household_demographics;
insert overwrite table income_band            select * from tpcds_300_text.income_band;
insert overwrite table item                   select * from tpcds_300_text.item;
insert overwrite table promotion              select * from tpcds_300_text.promotion;
insert overwrite table reason                 select * from tpcds_300_text.reason;
insert overwrite table ship_mode              select * from tpcds_300_text.ship_mode;
insert overwrite table store                  select * from tpcds_300_text.store;
insert overwrite table time_dim               select * from tpcds_300_text.time_dim;
insert overwrite table warehouse              select * from tpcds_300_text.warehouse;
insert overwrite table web_page               select * from tpcds_300_text.web_page;
insert overwrite table web_site               select * from tpcds_300_text.web_site;
...
select cs_sold_time_sk,
       ...
       cs_net_profit,
       cs_sold_date_sk
from tpcds_300_text.catalog_sales
...
select cr_returned_time_sk,
       ...
       cr_net_loss,
       cr_returned_date_sk
from tpcds_300_text.catalog_returns;
...
select ss_sold_time_sk,
       ...
       ss_net_profit,
       ss_sold_date_sk
from tpcds_300_text.store_sales
...
select sr_return_time_sk,
       ...
       sr_net_loss,
       sr_returned_date_sk
from tpcds_300_text.store_returns;
...
select wr_returned_time_sk,
       ...
       wr_net_loss,
       wr_returned_date_sk
from tpcds_300_text.web_returns;
